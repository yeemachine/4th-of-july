(function(window){
	...
	*/
	...
	var ParticleExample = function(imagePaths, config, type, useParticleContainer, stepColors)
	{
		...
		{
			bg = new PIXI.Sprite(PIXI.Texture.fromImage("https://cdn.glitch.com/5737c303-6e4f-44a9-bc1a-60808011e6ab%2Fbg.png?v=1561581924916"));
			//bg is a 1px by 1px image
			bg.scale.x = canvas.width;
			bg.scale.y = canvas.height;
			bg.tint = 0x000000;
			...
			canvas.addEventListener('mousedown', function(e){
				if(!emitter) return;
				emitter.emit = true;
        setTimeout(function(){ emitter.emit = false; }, 3000);
